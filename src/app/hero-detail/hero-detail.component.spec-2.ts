...
describe('Hero Detail Component', () => {
  ...
  beforeEach(async(() => {
    ...
    /* 
       The "TestBed.compileComponents()" is an asynchronous call - that's why we need to wrap the beforeEach function within a async()
       Please don't mistake this with the async / await feature of ES6 itself
       The async() function is provided by Angular.
...
* It's a helper object 
* It gives us access to the component instance under test
* It provides helper functions to interact with the rendered DOM of the component
...
--> we'll see this is in real life in the next exercise - LINK (hero-detail.component.spec-3.ts)
